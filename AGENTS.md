...
| **Plugin kit** (shared source package) | `plugin-kit/` (`src/client/chrome.tsx` extracted; K3-2/K3-3 queued) | before duplicating proved plugin logic | when a module is extracted (with its tests migrated) |
